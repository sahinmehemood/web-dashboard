...
import { History, Pause, Play, Search, Trash2 } from "lucide-react";
...
import type { ActivityLevel } from "@/lib/demo";
    ...
    <div className="space-y-6">
      ...
      >
        <Button
          ...
          size="sm"
          onClick={() => {
            toast.info("History is server-provided", {
              description: "In live mode this feed mirrors Convex activity events.",
            });
          }}
        >
        ...
        <CardHeader className="flex-row flex-wrap items-center justify-between space-y-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              variant="ghost"
              size="sm"
              onClick={() => toast.info("Cleared", { description: "Feed will repopulate on next refresh." })}
